    ...
    return (
        <>
            <Card draggable onDragStart={(e)=>dragStarted(e,displayData?.id)} className='shadow' >
                <Card.Img onClick={handleShow} style={{ height: '200px', cursor: 'pointer' }} variant="top" src={displayData?.imageURL} />
                <Card.Body>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                <iframe width="100%" height="360" src={`${displayData?.youtubeLink}?autoplay=1`} title="Heeriye (Official Video) Jasleen Royal ft Arijit Singh| Dulquer Salmaan| Aditya Sharma |Taani Tanvir"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </Modal.Body>
            </Modal>
        </>
    )
